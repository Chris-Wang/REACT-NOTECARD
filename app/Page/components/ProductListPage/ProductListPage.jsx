    ...
    render() {
        ...
        return (
            <>
                ...
                <Filter><Select options={options} placeholder="Sort by (Please Select One)" /></Filter>
                <Filter><Select options={options} placeholder="Refine by" /></Filter>
                ...
                <Container>
                    {productsData.map((products) => (
                        <Card key={products.productId} >
                            ...
                            <Rate><ProductRatingStar rating={products.rating} /></Rate>
                        </Card>
                    ))}
                </Container>
            </>
